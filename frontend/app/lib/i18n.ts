...
const en: Dict = {
  ...
  max_loss: "Max Loss",
  max_loss_sub: "if spot at maturity → 0",
  prob_itm: "P(assigned)",
  prob_itm_sub: "P(spot at maturity < K) ≈ N(−d2)",
  delta: "Put Delta",
  ...
  // payoff chart
  chart_payoff_title: "Payoff at Expiry · return on notional vs spot at maturity",
  legend_pnl: "Return on notional",
  ref_spot: "spot",
  ref_strike: "strike",
  ref_breakeven: "breakeven",
  ref_call: "call",
  ref_st: "spot at maturity",

  // scenario table
  scenario_title: "Scenario Analysis at Expiry",
  th_move: "Spot move",
  th_st: "Spot at maturity",
  th_return: "Return",
  ...
  ts_note_cash: "If spot at maturity ≥ K at expiry: return of principal + coupon. If spot at maturity < K: cash settlement, loss = (K − spot at maturity)/S₀.",
  ts_note_physical: "If spot at maturity ≥ K at expiry: return of principal + coupon. If spot at maturity < K: physical delivery — receive shares at strike K.",
  ts_print: "Print",
  ...
  currency: "Currency",
  coupon_hint: "Annualized coupon paid at maturity if not called and spot at maturity ≥ strike.",
...
const zh: Dict = {
  ...
  max_loss: "最大虧損",
  max_loss_sub: "當到期股價 → 0",
  prob_itm: "被行使機率",
  prob_itm_sub: "P(到期股價 < K) ≈ N(−d2)",
  delta: "認售 Delta",
  delta_sub: "對現價敏感度",
  s_spot: "現價",
  s_strike: "行使價",
  ...
  chart_payoff_title: "到期結算 · 本金報酬率 vs 到期股價",
  legend_pnl: "本金報酬率",
  ref_spot: "現價",
  ref_strike: "行使價",
  ref_breakeven: "打和價",
  ...
  ts_shares: "股數",
  ts_premium: "總權利金",
  ts_note_cash: "到期若股價 ≥ K：返還本金 + 票息。若股價 < K：現金結算，虧損 = (K − 到期股價)/S₀。",
  ts_note_physical: "到期若股價 ≥ K：返還本金 + 票息。若股價 < K：實物交收——按行使價 K 收取股票。",
  ts_print: "列印",
  ts_copy: "複製摘要",
  ts_copied: "已複製 ✓",
  ...
  // coupon 輸入 + 自動贖回（call）
  currency: "貨幣",
  coupon_hint: "未被贖回且到期股價 ≥ 行使價時支付的年化票息。",
  call_level: "贖回水平",
